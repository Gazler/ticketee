Feature: Gmail
  ...
  Background:
    Given there are the following users:
      ...
      | gazlertest@gmail.com   | password |

    Given Action Mailer delivers via SMTP
    Given there is a project called "TextMate 2"
    And "alice@ticketee.com" can view the "TextMate 2" project
    And "gazlertest@gmail.com" can view the "TextMate 2" project
    And "gazlertest@gmail.com" has created a ticket for this project:
      |title | description |
